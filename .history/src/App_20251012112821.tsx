        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <div className={`p-6 rounded-xl ${darkMode ? 'bg-gray-900' : 'bg-white'} shadow-lg`}>
              ...
              <p className={`${darkMode ? 'text-gray-300' : 'text-gray-600'} mb-3`}>
              Specialized in customer service and technical coordination for electronic and automotive equipment. Proficient in managing equipment repairs, performing basic diagnostics, and ensuring efficient communication between specialized technicians and clients. Gained valuable experience in conflict resolution and claims management with a focus on customer satisfaction.  
              </p>
              <div className="flex flex-wrap gap-2">
                {[].map((skill) => (
                  <span key={skill} className={`px-3 py-1 rounded-full text-sm ${darkMode ? 'bg-gray-800 text-gray-300' : 'bg-gray-200 text-gray-700'}`}>
